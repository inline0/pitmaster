...
cp "${PITMASTER_ROOT}/fixtures/upstream/go-git/data/pack-bc4b855a55cae7703c023d4e36e3a7c9f5d84491.pack" .git/objects/pack/
cp "${PITMASTER_ROOT}/fixtures/upstream/go-git/data/pack-bc4b855a55cae7703c023d4e36e3a7c9f5d84491.idx" .git/objects/pack/
